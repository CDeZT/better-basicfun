...
This directory is managed as the safe default Workspace by the \`dsh-foundation-enhancements\` plugin.
...
For reasoning controls, trust a model's explicit \`reasoningEfforts\` mapping first. The foundation guard only fills a small evidence-backed set for third-party gateways and leaves unknown or native models untouched.
