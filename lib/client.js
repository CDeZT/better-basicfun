...
.bre-effort-slider::before {
  ...
  pointer-events: none;
  opacity: .9;
  background: repeating-linear-gradient(to right, rgba(255,255,255,.9) 0 2px, transparent 2px var(--bre-level-step));
}
